...
You will see either a 68 or a 69 if the MPU-6050 is connected properly. If the address is 69, you will need to change the address to 0x68 using the technique recommended for your board (AD0 jumper). You may see other numbers is the results if you have other I2C components included in your assembled device, these are unrelated to the board.
