...
##poggr.com
<a href='http://www.poggr.com/home/#' target='_blank'>poggr.com</a> is a web based authoring platform I built as a tool to create, share, and test ideas and experiments. It is the scaffolding I use regularly for rapid prototyping, sharing, and testing web app ideas. I originally built poggr to explore browser-based authoring of simple interactive content. One learning from Local202 was volunteer event/activity coordination required more than  scheduling and communication, as that was already supported well enough by social networks like Facebook and Twitter. What was missing and needed was  more dynamic and domain specific application features. There wasn't a  service for this at the time so I started to look at a platform for deploying simple interactive web apps that leveraged the coming web component standards.

Poggr is an authoring and publishing platform designed to support simple content creation using web components, but in a way that  affords the ability to grow applications into a more sophisticated form as the user's skills grow. It is a riff off the Douglas Engelbart quote: “If ease of use were the only requirement, we would all be riding tricycles.” Basically the goal was to provide a template based  authoring environment that can start with simple markdown and spreadsheets (training wheels), but support arbitrary growth in the user's skills in creating HTML5 content (racing bike). So the  approach was not to hide code, but instead to hide everything else (dependencies, versioning, deployment, etc)  That was the goal of Poggr; easy to get something simple published, but powerful as you need it to be as you grow your app.
